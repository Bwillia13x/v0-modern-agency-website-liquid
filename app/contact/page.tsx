...
export const metadata: Metadata = {
    title: "Contact Us | Book Your Free Consultation - Calgary Consulting",
    description:
        "Ready to grow your business or social media presence? Contact Calgary Consulting for a free consultation. Expert guidance for influencers and Calgary businesses.",
}
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                            Book your free consultation and discover how Calgary Consulting can help you achieve your digital growth goals.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        ...
                        <Card className="liquid-glass border-gray-800 hover:border-purple-300/30 transition-colors duration-300">
                            <CardContent className="p-6 md:p-8">
                                ...
                                <form
                                    action="mailto:hello@calgaryconsulting.com"
                                    method="POST"
                                    encType="text/plain"
                                    className="space-y-6"
                                >
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="service" className="text-gray-300 font-medium">Service Interest *</Label>
                                        <select
                                            id="service"
                                            name="service"
                                            required
                               ...
                               active:scale-[0.98] transition-all duration-200"
                                    ...
                                    <p className="text-xs text-gray-500 text-center">
                                        By submitting, you agree to our <a href="/t&c" className="text-purple-300 hover:text-purple-200 underline">Terms & Conditions</a>
                                    </p>
                                </form>
                            </CardContent>
                        </Card>
                        ...
                        <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <a href="mailto:hello@calgaryconsulting.com" className="text-gray-400 hover:text-purple-300 transition-colors">
                                                    hello@calgaryconsulting.com
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-400">
                                                    ...
                                                    Saturday: 10:00 AM - 2:00 PM MST<br />
                                                    Sunday: Closed
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <Card className="liquid-glass border-gray-800 hover:border-purple-300/30 transition-colors duration-300">
                                <CardContent className="p-6">
                                    <h3 className="text-xl font-bold mb-4">Why Choose Calgary Consulting?</h3>
