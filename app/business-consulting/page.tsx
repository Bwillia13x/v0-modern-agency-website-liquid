...
export const metadata: Metadata = {
  title: "Business Consulting Services | Calgary Digital Marketing & Strategy",
  description:
    "Grow your Calgary business with expert digital marketing and strategic consulting. Local expertise, proven results, and personalized strategies for small to medium-sized businesses.",
}
      ...
      <main className="bg-background text-foreground">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 pb-8 pt-10 md:pt-16">
          <div className="flex items-center justify-center">
            <Badge className="rounded-full bg-secondary text-secondary-foreground">Business Consulting</Badge>
          </div>

          <h1 className="mx-auto mt-6 max-w-4xl text-balance text-center text-4xl font-semibold leading-tight md:text-6xl">
            <span className="italic font-normal">Scale</span> <span className="font-extrabold">your Calgary</span>{" "}
            <span className="italic font-normal">business with</span> expert digital strategy
          </h1>

          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Comprehensive business consulting tailored for Calgary's dynamic market. From digital marketing to brand development,
            we help local businesses achieve measurable growth and sustainable success.
          </p>
          ...
          <div className="mt-6 flex justify-center">
            <div className="rounded-full bg-secondary px-4 py-2 text-sm shadow-sm">
              <span className="mr-2">✦</span> Serving Calgary businesses since 2015{" "}
