      ...
      <main className="bg-background text-foreground">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 pb-8 pt-10 md:pt-16">
          <div className="flex items-center justify-center">
            <Badge className="rounded-full bg-secondary text-secondary-foreground">Brand Partnerships</Badge>
          </div>

          <h1 className="mx-auto mt-6 max-w-4xl text-balance text-center text-4xl font-semibold leading-tight md:text-6xl">
            <span className="italic font-normal">Build</span> <span className="font-extrabold">authentic brand</span>{" "}
            <span className="italic font-normal">partnerships that</span> grow your influence
          </h1>

          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Navigate brand deals with confidence. Our expert consulting helps influencers connect with the right brands,
            negotiate fair terms, and create partnerships that resonate with your audience.
          </p>
          ...
          <div className="mt-6 flex justify-center">
            <div className="rounded-full bg-secondary px-4 py-2 text-sm shadow-sm">
              <span className="mr-2">✦</span> Calgary-based expertise for local & national campaigns{" "}
